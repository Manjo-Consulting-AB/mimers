...
Laravel på PHP 8.3, MariaDB 10.6. Kodstandard (Pint), statisk analys (PHPStan), testuppsättning (Pest eller PHPUnit). CI som kör lint, analys och tester på varje PR.
**Läs:** [[ADR-0001 Stack]]
**Klart när:** `composer test` och `composer lint` går grönt i CI på en tom kodbas.
**Beror på:** 0
