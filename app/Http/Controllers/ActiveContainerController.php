...
/**
 * PUT /containers/{container}/active — gör en container till sessionens aktiva,
 ...
 *
 * **Auktoriseringen är `view`, inte `update`.** Att välja vilken container man
 * arbetar i är att läsa, inte att skriva: en `read`-innehavare ska kunna göra
 * containern aktiv, och det är samma grind som `GET /containers` ställer för att
