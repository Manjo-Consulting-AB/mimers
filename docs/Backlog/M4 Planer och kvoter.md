...
**Beror på:** 16, 25
**Byggd som:** 26a `usage_counter` och de transaktionella uppdateringarna, 26b det nattliga avstämningsjobbet
...
**Beror på:** 26
**Byggd som:** 27a mekanismen (`Entitlements`), containertaket och delningstaket, 27b uppladdningens styckstorlek och totalkvot
...
**Beror på:** 27
**Byggd som:** 28a `read_only`, fristen och urvalslistan, 28b den automatiska raderingen nyast först och återgången till `active`
...
**Beror på:** 27
**Byggd som:** 29a aktivitetsdefinitionen, påminnelseläget och stängningen vid 15 månader, 29b raderingen vid 18 månader och de tre undantagen
