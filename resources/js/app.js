 ...
 * språket inte ändras under sessionen. Det gör det: profilsidan byter locale
 * med en Inertia-visit, och en visit ritar om sidan i webbläsaren utan att
 * rotvyn renderas på nytt. Utan raden nedan står `lang="sv"` kvar över en
 * engelsk sida, och varje skärmläsare uttalar den med fel röst.
 *
