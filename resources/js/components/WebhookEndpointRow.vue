...
/*
 * En rad i kontots webhooklista, se issue 65b § Beslut 6, 7 och 8.
 *
 ...
 * för en ny endpoint är den enda vägen till en ny hemlighet.
 *
...
<template>
    <li
        ...
        :class="endpoint.is_active ? null : 'text-slate-500'"
    >
